...
//
//	Category.php
//	The default template for displaying category archive content.
//
//----------------------------------------------------------------------------------------------------------------------------
...
get_header(); ?>
	...
	<div id="content" class="blog grid twelve columns"><!-- BEGIN #content -->
		...
		<h3 class="entry-title"><?php printf( __( 'Category Archives: %s', 'tva' ), '<span>' . single_cat_title( '', false ) . '</span>' ); ?></h3>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class( 'item item-overlay' ); ?>><!-- Begin #post-<?php the_ID(); ?> -->
